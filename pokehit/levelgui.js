...
function(t, e) {
    ...
    o.prototype.initButtons = function() {
        var t = this,
            e = 60;
        this.pauseButton = new i(this.game, this.game.width - 60, e, "buttonsgroup", "pause.png"), 
        t.add(this.pauseButton);
        var s = 0;
        this.pauseButton.callback.add(function() {
            this.game.time.now > s && (t._pauseSignal.dispatch("pause"), 
    ...
    o.prototype.onLevelFail = function() {
        this.pauseButton.visible = !1, this.levelFailBoard.show()
    }, 
    ...
    o.prototype.onPause = function() {
        this.pauseButton.inputEnabled = !1, this.pauseButton.visible = !1, this.pauseBoard.show()
    }, 
