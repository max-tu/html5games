 function(t, e) {
    ...
    i.prototype = {
        ...
        setupStage: function() {
            ...
            t.scaleMode = Phaser.ScaleManager.SHOW_ALL, 
            t.pageAlignHorizontally = !0, 
            t.pageAlignVertically = !0, 
            t.enterIncorrectOrientation.add(this.onEnterIncorrectOrientation, this),
            t.leaveIncorrectOrientation.add(this.onLeaveIncorrectOrientation, this), 
            t.setScreenSize(!0), 
