...
function(t, e) {
    var i = t("./simplebutton"),
        s = t("./togglebutton"),
        n = function(t, e, i) {
            Phaser.Group.call(this, t, e, "Level Fail Board"), 
    ...
    n.prototype = Object.create(Phaser.Group.prototype), 
    n.prototype.constructor = n, 
    n.prototype.addBackGround = function() {
        var t = this.game.add.graphics(0, 0, this);
        t.beginFill(0, .5), t.drawRect(0, 0, this.game.width, this.game.height), 
        t.endFill()
    }, 
    n.prototype.initText = function() {
        ...
        i.anchor.set(.5, .5), i.setShadow(2, 2, "#FB1A05", 2), 
        this.add(i)
    }, 
    n.prototype.addButtons = function() {
        var t = this,
            ...
            n = 120;
        this.menuBtn = new i(this.game, this.game.width / 2, e, "buttonsgroup", "menu.png"),

        this.menuBtn.callback.addOnce(function() {
            t.game.state.start("levelsmenu")
        }, this), 
        this.soundBtn = new s(this.game, this.menuBtn.x - n, e,
        ...
        this.restartBtn = new i(this.game, this.menuBtn.x + n, e, "buttonsgroup", "restart.png"), 
        this.restartBtn.callback.addOnce(function() {
            t.game.state.start("level", !0, !1, t.levelNumber)
        }, this), this.buttons = [this.menuBtn, this.soundBtn, this.restartBtn], 
    ...
    n.prototype.onShowComplete = function() {}, 
    e.exports = n
}