...
function(t, e) {
            ...
            this.levels_num = this.game.global.levels_num,
             this.levelNumber = i,
              ...
              this.initPokemon(this._level2pokemon.pokemon, this._level2pokemon.pokemon_name, 
                this._level2pokemon.pokemon_icon), this.addButtons()
        };
    ...
    a.prototype.initPokemon = function(t, e, i) {
        this.icon = new Phaser.Image(this.game, this.game.width / 2 - 100, this.game.height / 2 - 100,
         t, i), 
    ...
    a.prototype.show = function() {
        ...
        this.game.add.tween(this.icon.scale).to({
            ...
            this.ballopening.position.set(this.game.width / 2, this.game.height / 2 - 
                this.ballopening.height / 2)
        }, this)
    }, e.exports = a
}