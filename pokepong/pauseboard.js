...
function(t, e) {
    var i = t("./simplebutton"),
        s = t("./togglebutton"),
        n = function(t, e) {
            Phaser.Group.call(this, t, e, "Pause Board"), 
            this.addBackGround(), 
    ...
    n.prototype.addButtons = function() {
        ...
        }), this.soundBtn = new s(this.game, this.menuBtn.x - n, e, "buttonsgroup", 
        "sound.png", "mute.png"), 
        ...
        this._resumeButton = new i(this.game, this.menuBtn.x + n + .25, e, 
