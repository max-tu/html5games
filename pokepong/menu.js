...
function(t, e) {
    ...
    i.prototype = {
        ...
        create: function() {
            ...
            this.initCredits(), 
            this.initAnimation(), 
            this.game.global.enable_sound && this.fromPreloader && (
        ...
        addButtons: function() {
            var t = this,
                ...
                i = 140;
            this.playButton = new s(this.game, this.game.width / 2, e, 
            ...
            this.soundButton = new n(this.game, this.playButton.x - i, 
        ...
        initAnimation: function() {
            var t = this;
            this.titleText.y -= 250, this.titleText.scale.set(0, 1), 
